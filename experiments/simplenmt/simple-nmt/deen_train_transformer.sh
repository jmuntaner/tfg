...
#SBATCH --ignore-pbs                                                            
#SBATCH --output=/home/usuaris/veu/joan.muntaner/experiments/outputs/deen_transformer.log
...
--gpu_id 0 --batch_size 128 --n_epochs 40 --max_length 100 --dropout .2 \
...
--model_fn ./model.deen.transformer.pth
