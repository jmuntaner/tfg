...
#SBATCH --ignore-pbs                                                            
#SBATCH --output=/home/usuaris/veu/joan.muntaner/experiments/outputs/neen_nobpe_mle.log
...
python train.py --train $DATA_DIR/train --valid $DATA_DIR/valid --lang neen \
